...
final class ControllerDiscoveryTest extends TestCase
{
    ...
    public function testNoBaseController(): void
    {
        ...
        $this->expectExceptionMessage('Class Tests\Php\Framework\Routing\Fixtures1\NoBaseController does not extend BaseController');

        ControllerDiscovery::discover(
            directory: __DIR__ . '/../Routing/Fixtures1',
            namespace: 'Tests\\Php\\Framework\\Routing\\Fixtures1'
        );
    }
    ...
    public function testClassNotFound(): void
    {
        ...
        $this->expectExceptionMessage('Class Tests\Php\Framework\Routing\Fixtures2\ClassNotFoundController does not exist');

        ControllerDiscovery::discover(
            directory: __DIR__ . '/../Routing/Fixtures2',
            namespace: 'Tests\\Php\\Framework\\Routing\\Fixtures2'
        );
    }
}
